...
class Colors {
  final Color _mainColor = Color(0xFFFFFFFF);
  final Color _secondColor = Color(0xFFF5F6FC);
  ...
  LinearGradient waves = LinearGradient(
    colors: const [Color(0xFF0396FF), Color(0xFFABDCFF)],
    begin: Alignment.bottomRight,
    end: Alignment.topLeft,
  );

  LinearGradient deepSpace = LinearGradient(
    colors: const [Color(0xFF4CA1AF), Color(0xFF2C3E50)],
    begin: Alignment.topRight,
    end: Alignment.bottomLeft,
  );
  LinearGradient peachy = LinearGradient(
    colors: const [Color(0xFFFFB382), Color(0xFFF07590)],
    begin: Alignment.topRight,
    end: Alignment.bottomLeft,
  );
  LinearGradient nebula = LinearGradient(
    colors: const [Color(0xFFA1A3FF), Color(0xFF6D63EF)],
    begin: Alignment.topRight,
    end: Alignment.bottomLeft,
  );
  LinearGradient mildSea = LinearGradient(
    colors: const [Color(0xFF96EFA6), Color(0xFF26A6B5)],
    begin: Alignment.topRight,
    end: Alignment.bottomLeft,
  );
  LinearGradient mildSeaRev = LinearGradient(
    colors: const [Color(0xFF26A6B5), Color(0xFF96EFA6)],
    begin: Alignment.topRight,
    end: Alignment.bottomLeft,
  );
  LinearGradient purplin = LinearGradient(
    colors: const [Color(0xFFA044FF), Color(0xFF6A3093)],
    begin: Alignment.topRight,
    end: Alignment.bottomLeft,
  );

  LinearGradient easyMed = LinearGradient(
    colors: const [Color(0xFF45B649), Color(0xFFDCE35B)],
    begin: Alignment.topRight,
    end: Alignment.bottomLeft,
  );

  LinearGradient disco = LinearGradient(
    colors: const [Color(0xFFB06AB3), Color(0xFF4568DC)],
    begin: Alignment.topRight,
    end: Alignment.bottomLeft,
  );
  ...
  LinearGradient alive = LinearGradient(
    colors: const [Color(0xFFBD3F32), Color(0xFFCB356B)],
    begin: Alignment.topRight,
    end: Alignment.bottomLeft,
  );
